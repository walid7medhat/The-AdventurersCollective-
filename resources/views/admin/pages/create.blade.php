  ...
  <div class="content-wrapper">
       ...
       <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>@lang('site.create') @lang('site.page')</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{url('/')}}/admin">@lang('site.dashboard')</a></li>
                  <li class="breadcrumb-item "><a href="{{url('/')}}/admin/setting/pages">@lang('site.pages')</a></li>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">@lang('site.create') <small>@lang('site.page') @lang('site.new')</small></h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" action="{{url('/')}}/admin/setting/pages" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                               <div class="form-group col-12">
                                                ...
                                                <div class="form-group col-12">
                                                    <label for="exampleInputtitle_ar">@lang('site.title_ar')</label>
                                                    <input type="text" name="title_ar" value="{{old('title_ar')}}"  class="form-control" id="exampleInputtitle_ar" placeholder="@lang('site.Enter title_ar')">
                                                    @error('title_ar')
                                                    <label class="alert alert-danger ">{{$message}}</label>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <input type="title_en" name="title_en" value="{{old('title_en')}}"  class="form-control" id="exampleInputtitle_en" placeholder="@lang('site.Enter title_en')">
                                                    @error('title_en')
                                                    <label class="alert alert-danger ">{{$message}}</label>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="row">
                                                  <div class="form-group col-12">
                                                      ...
                                                      <textarea class="summernote" name="page_ar" id="summernote"> {{old('page_ar')}} </textarea>
                                                      @error('page_ar')
                                                  ...
                                                  <div class="form-group col-12">
                                                      ...
                                                      <textarea class="summernote" name="page_en" id="summernote">{{old('page_en')}}</textarea>
                                                      @error('page_en')
                                                          <span class="alert alert-danger">{{$message}}</span>
                                                      @enderror
                                                  </div>
